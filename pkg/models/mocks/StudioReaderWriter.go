...
func (_m *StudioReaderWriter) DistinctCustomFieldNames(ctx context.Context) ([]string, error) {
	ret := _m.Called(ctx)
...
func (_m *StudioReaderWriter) QueryAST(ctx context.Context, filterAST *models.FilterAST, findFilter *models.FindFilterType) ([]*models.Studio, int, error) {
	ret := _m.Called(ctx, filterAST, findFilter)

	var r0 []*models.Studio
	if rf, ok := ret.Get(0).(func(context.Context, *models.FilterAST, *models.FindFilterType) []*models.Studio); ok {

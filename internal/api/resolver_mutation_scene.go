...
// sceneSetDateFromMTimeOperation is the per-id worker for
// scenesSetDateFromFileMTime. Each Update finds the scene, loads its primary
// file, and writes that file's mtime back as the scene's date.

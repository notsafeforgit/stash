...
extension points. Follow the [development guide](development.md) for setup and
validation; the [documentation index](../../../docs/README.md) links the current
feature guides. The [original plan](archive/rewrite-plan.md) and
...
1. Identify the existing extension point and propose changes to user-visible
   behavior. Preserve the documented zoom and text-selection policies unless
...
4. Update the current guide for any changed behavior, API, or operational step.
   Keep proposed work separate from implemented behavior and leave archived
   checklists as historical snapshots.

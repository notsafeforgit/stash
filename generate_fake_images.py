...
def main():
    ...
    # Create a couple exact duplicates (distance 0)
    insert_image(cur, 1001, "Duplicate Image A", "9f0a1e34b07d8e8a")
    insert_image(cur, 1002, "Duplicate Image B", "9f0a1e34b07d8e8a", file_size=500000, width=800, height=600)

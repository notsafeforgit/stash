...
func (_m *SceneReaderWriter) DistinctCustomFieldNames(ctx context.Context) ([]string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for DistinctCustomFieldNames")
	}
...
func (_m *SceneReaderWriter) FindDuplicateGroups(ctx context.Context, distance int, durationDiff float64, filter *models.SceneFilterType, filterAST *models.FilterAST, filterMode models.DuplicateFilterMode, findFilter *models.FindFilterType) ([][]*models.Scene, int, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for FindDuplicateGroups")
	}

	var r0 [][]*models.Scene
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, int, float64, *models.SceneFilterType, *models.FilterAST, models.DuplicateFilterMode, *models.FindFilterType) ([][]*models.Scene, int, error)); ok {
		return rf(ctx, distance, durationDiff, filter, filterAST, filterMode, findFilter)
	}
...
func (_m *SceneReaderWriter) FindDuplicates(ctx context.Context, distance int, durationDiff float64, filter *models.SceneFilterType, filterAST *models.FilterAST, filterMode models.DuplicateFilterMode) ([][]*models.Scene, error) {
	...
	var r0 [][]*models.Scene
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int, float64, *models.SceneFilterType, *models.FilterAST, models.DuplicateFilterMode) ([][]*models.Scene, error)); ok {
		return rf(ctx, distance, durationDiff, filter, filterAST, filterMode)
	}
...
// GetCoverSource provides a mock function with given fields: ctx, sceneID
func (_m *SceneReaderWriter) GetCoverSource(ctx context.Context, sceneID int) (*models.SceneCoverSource, error) {
	ret := _m.Called(ctx, sceneID)

	if len(ret) == 0 {
		panic("no return value specified for GetCoverSource")
	}

	var r0 *models.SceneCoverSource
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) (*models.SceneCoverSource, error)); ok {
		return rf(ctx, sceneID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int) *models.SceneCoverSource); ok {
		r0 = rf(ctx, sceneID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.SceneCoverSource)
		}
	}
...
func (_m *SceneReaderWriter) GetManyHasCover(ctx context.Context, ids []int) ([]bool, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetManyHasCover")
	}
...
func (_m *SceneReaderWriter) GetManyIDsByFileIDs(ctx context.Context, fileIDs []models.FileID) ([][]int, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetManyIDsByFileIDs")
	}
...
func (_m *SceneReaderWriter) OCountByGroupID(ctx context.Context, groupID int) (int, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for OCountByGroupID")
	}
...
func (_m *SceneReaderWriter) OCountByStudioID(ctx context.Context, studioID int, depth int) (int, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for OCountByStudioID")
	}
...
func (_m *SceneReaderWriter) QueryAST(ctx context.Context, filterAST *models.FilterAST, findFilter *models.FindFilterType) ([]*models.Scene, int, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for QueryAST")
	}

	var r0 []*models.Scene
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *models.FilterAST, *models.FindFilterType) ([]*models.Scene, int, error)); ok {
		return rf(ctx, filterAST, findFilter)
	}
...
// SetCoverSource provides a mock function with given fields: ctx, sceneID, source
func (_m *SceneReaderWriter) SetCoverSource(ctx context.Context, sceneID int, source *models.SceneCoverSource) error {
	ret := _m.Called(ctx, sceneID, source)

	if len(ret) == 0 {
		panic("no return value specified for SetCoverSource")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int, *models.SceneCoverSource) error); ok {
		r0 = rf(ctx, sceneID, source)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *SceneReaderWriter) SetCustomFields(ctx context.Context, id int, fields models.CustomFieldsInput) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for SetCustomFields")
	}

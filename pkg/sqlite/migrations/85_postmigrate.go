...
type schema85Migrator struct {
	migrator
}

func (m *schema85Migrator) migrateSavedFilters(ctx context.Context) error {
...
func (m *schema85Migrator) convertObjectFilter(data []byte) ([]byte, error) {

	...
	if err := r.withTxn(ctx, func(ctx context.Context) error {
		...
		if updatedPerformer.Aliases != nil {
			...
			if p != nil {
				...
				if updatedPerformer.Aliases.Mode == models.RelationshipUpdateModeSet {
				...
				} else if updatedPerformer.Aliases.Mode == models.RelationshipUpdateModeAdd {
					effectiveAliases = append(p.Aliases.List(), updatedPerformer.Aliases.Values...)
				} else if updatedPerformer.Aliases.Mode == models.RelationshipUpdateModeRemove {

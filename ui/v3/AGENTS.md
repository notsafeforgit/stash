...
- `make test-ui-v3-browser` runs the Chromium/WebKit toolbar regression suite; see the development guide for browser installation. The suite starts its own fixture server and needs no backend.

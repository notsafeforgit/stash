...
func (_m *TagReaderWriter) DistinctCustomFieldNames(ctx context.Context) ([]string, error) {
	ret := _m.Called(ctx)
...
func (_m *TagReaderWriter) QueryAST(ctx context.Context, filterAST *models.FilterAST, findFilter *models.FindFilterType) ([]*models.Tag, int, error) {
	ret := _m.Called(ctx, filterAST, findFilter)

	var r0 []*models.Tag
	if rf, ok := ret.Get(0).(func(context.Context, *models.FilterAST, *models.FindFilterType) []*models.Tag); ok {
